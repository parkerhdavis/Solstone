...
OBSERVER_LOCALHOST_BANNER_LINE_4 = (
    "to allow network access: journal settings convey network-access enable"
)
OBSERVER_LOCALHOST_REMINDER = "reminder: convey is in localhost-only mode. this observer can't reach convey from another device until you run: journal settings convey network-access enable"
